        ...
        <section className='pt-20 ' id='work'>
            ...
            <motion.div initial={{ opacity: 0, }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.5 }}>
                {EXPERIENCES.map((experience, index) => (
                    <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: index * 0.2 }} key={index} className=' mt-6 rounded-xl border border-stone-50/30 bg-white/10 p-4 '>
